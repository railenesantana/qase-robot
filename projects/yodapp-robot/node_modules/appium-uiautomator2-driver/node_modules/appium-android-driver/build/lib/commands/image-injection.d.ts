 ...
 */
export function prepareEmulatorForImageInjection(this: import("../driver").AndroidDriver, sdkRoot: string): Promise<boolean>;
/**
 ...
 */
export function mobileInjectEmulatorCameraImage(this: import("../driver").AndroidDriver, opts: import("./types").ImageInjectionOpts): Promise<void>;

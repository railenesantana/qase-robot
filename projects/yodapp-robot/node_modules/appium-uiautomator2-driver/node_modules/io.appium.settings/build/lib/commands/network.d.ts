 ...
 */
export function setWifiState(this: import("../client").SettingsApp, on: boolean, isEmulator?: boolean | undefined): Promise<void>;
/**
 ...
 *                                       is an emulator rather than a real device.
 */
export function setDataState(this: import("../client").SettingsApp, on: boolean, isEmulator?: boolean | undefined): Promise<void>;
